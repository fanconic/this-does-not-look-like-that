...
def prune_prototypes(
    ...
    if copy_prototype_imgs:
        ...
        for idx in range(len(prototypes_to_keep)):
            shutil.copyfile(
                src=os.path.join(
                    original_img_dir, "prototype-img%d.png" % prototypes_to_keep[idx]
                ),
            ...
            shutil.copyfile(
                ...
                dst=os.path.join(
                    dst_img_dir, "prototype-img-original_with_self_act%d.png" % idx
                ),
            )
            ...
            np.save(
                os.path.join(dst_img_dir, "bb-receptive_field%d.npy" % epoch_number),
                bb_rf,
            )
